...
BEGIN_MESSAGE_MAP(CMyUMLEditor2App, CWinApp)
...
CMyUMLEditor2App::CMyUMLEditor2App()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMyUMLEditor2App 物件

CMyUMLEditor2App theApp;


// CMyUMLEditor2App 初始設定

BOOL CMyUMLEditor2App::InitInstance()
{
